...
class Product(_GpSweep):
    def _add_parameters(self):
        ...
        self._add_log_range_param("sqe_kernel_scale", 5.538930746200925)
        self._add_log_range_param("period", 0.5082224844864489, scale_factor=4)
        self._add_log_range_param("per_length_scale", 0.7270981370167336)
        self._add_log_range_param("per_kernel_scale", 0.0974970247641131)
