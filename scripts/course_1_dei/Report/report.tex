...
Within the domain of such Gaussian Processes, we start off by considering two Gaussian processes denoted by sqe\textunderscore 1 and sqe\textunderscore 2, as described in Table \ref{table:sqe_table}. Samples from the prior distributions of sqe\textunderscore 1 and sqe\textunderscore 1 are shown in Figure \ref{fig:prior_samples}.
...
\begin{figure}[ht]
    \centering
    \subfloat[
        \centering Samples from the prior distribution of Gaussian Process sqe\textunderscore 1
        \label{fig:prior_sqe_1}
    ]{
        \includegraphics[width=0.45\textwidth]{Samples_from_GP_prior,_GP____sqe_1_.png}
    }
    \subfloat[
        \centering Samples from the prior distribution of Gaussian Process sqe\textunderscore 2
