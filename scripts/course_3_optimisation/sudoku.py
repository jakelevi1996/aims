...
# mapping coordinates to elements in x. x_from_coord[val, row, col] ==
...
# x_from_coord[1, 3, 5] + x_from_coord[2, 3, 5] + ... + x_from_coord[9, 3, 5]
# == 1
for row in numbers_1_to_9:
    for col in numbers_1_to_9:
        constraints.append(
...
# x_from_coord[2, 8, 1] + x_from_coord[2, 8, 2] + ... + x_from_coord[2, 8, 9]
# == 1
for val in numbers_1_to_9:
    for row in numbers_1_to_9:
        constraints.append(
...
# column, x_from_coord[7, 1, 4] + x_from_coord[7, 2, 4] + ... + x_from_coord[7,
# 9, 4] == 1
for val in numbers_1_to_9:
    for col in numbers_1_to_9:
        constraints.append(
...
# which is 3 down and 2 accross, x_from_coord[8, 7, 4] + x_from_coord[8, 7, 5]
